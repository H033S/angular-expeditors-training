import {productsURL, FoodProduct, customersURL, Product} from '../lib';
...
async function runTheLearningSamples() {
  ...
  function whatIsIt_String(arg: number): number {
    return arg;
  }
  ...
  let s: string = whatIsIt_typed<string>("hello");
